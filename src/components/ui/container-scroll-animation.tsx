...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className=' -mt-12 mx-auto h-[30rem] md:h-[40rem] w-[50rem] border border-white/75 dark:border-[#6C6C6C] bg-gray-100/20 dark:bg-[#22222269] backdrop-blur-xl rounded-[30px] shadow-2xl'
        >
